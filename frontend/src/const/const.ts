export const BTN_HEIGHT_XS = "h-8";    
export const BTN_HEIGHT_SM = "h-10";   
export const BTN_HEIGHT_MD = "h-12";   
export const BTN_HEIGHT_LG = "h-14";   
export const BTN_HEIGHT_XL = "h-16";   

export const BTN_WIDTH_XS = "w-20";    
export const BTN_WIDTH_SM = "w-28";    
export const BTN_WIDTH_MD = "w-36";    
export const BTN_WIDTH_LG = "w-48";    
export const BTN_WIDTH_XL = "w-64";    
