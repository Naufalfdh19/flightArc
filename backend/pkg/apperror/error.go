...
var (
	...
	ErrSeatIsReserved              = errors.New("seat is reserved")
	ErrAddBookings                 = errors.New("add bookings failed")
	ErrBookingNotExists            = errors.New("booking not exists")
	ErrPaymentNotExists            = errors.New("payment not exists")
	ErrPaymentStatusInvalid        = errors.New("payment status invalid")
	ErrPaymentBookingInvalidStatus = errors.New("booking is not payable")
)
