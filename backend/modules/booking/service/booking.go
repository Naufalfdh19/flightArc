...
type BookingService interface {
	...
	AddBookings(ctx context.Context, bookingReq dto.AddBookingReq) (*uuid.UUID, error)
...
func (s *BookingServiceImpl) AddBookings(ctx context.Context, bookingReq dto.AddBookingReq) (*uuid.UUID, error) {
